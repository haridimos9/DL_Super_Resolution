...
parser.add_argument(
    "-o", "--output", default="Results/", help="Location to save test results"
)
parser.add_argument(
    "-s", "--upscale_factor", type=int, default=4, help="Super-Resolution Scale Factor"
)
...
parser.add_argument(
    ...
    type=bool,
    default=True,
    help="Use a dataset that isn't vimeo-90k",
)
...
parser.add_argument(
    "-d", "--debug", action="store_true", required=False, help="Print debug spew."
)
parser.add_argument(
    "-u",
    "--upscale_only",
